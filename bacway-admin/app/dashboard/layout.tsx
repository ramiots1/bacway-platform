      ...
      <div className="max-h-80 overflow-y-auto">
        {notifications.map((n) => (
          <div
            ...
            style={{
              borderColor: "#1a1a1a",
              background: n.read ? "transparent" : "#00c8ff06",
            }}
          >
    ...
    >
      ...
      >
        <div
          ...
          style={{ borderColor: "#181818", height: 56 }}
        >
          {collapsed ? (
          ...
          {NAV.map((item) => {
            ...
            return (
              <Link
                ...
                style={{
                  background: active ? "#00c8ff12" : "transparent",
        ...
        <div
          className="px-2 pb-3 pt-3 space-y-0.5 border-t"
          style={{ borderColor: "#181818" }}
        >
          <button
            onClick={() => setCollapsed(!collapsed)}
            className="flex items-center gap-3 px-2.5 py-2.5 rounded-xl text-sm w-full"
            style={{ color: "#333" }}
          >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header
          ...
          style={{ height: 56, background: "#0a0a0a", borderColor: "#181818" }}
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                style={{
                  background: showNotif ? "#00c8ff15" : "#161616",
                  color: showNotif ? "#00c8ff" : "#666",
                }}
              >
                🔔
                {unreadCount > 0 && (
