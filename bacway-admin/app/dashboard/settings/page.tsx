    ...
    <div className="p-6 lg:p-8 max-w-3xl mx-auto space-y-5">
      <div className="mb-7">
        ...
        <p className="text-sm mt-1" style={{ color: "#555" }}>
          Configure your BACWAY admin panel preferences
        </p>
      </div>
      ...
      {saved && (
        <div
          ...
          style={{
            background: "#10b981",
            color: "#fff",
            boxShadow: "0 10px 30px #10b98150",
          }}
        >
          ✓ Settings saved
        </div>
      ...
      <Section
        ...
        description="Configure automated emails sent to contributors"
      >
        <div className="space-y-4">
          <Toggle
            ...
            onChange={(v) =>
              setEmailSettings((s) => ({ ...s, sendOnAccept: v }))
            }
          />
          <Toggle
            ...
            onChange={(v) =>
              setEmailSettings((s) => ({ ...s, sendOnReject: v }))
            }
          />
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            {[
              ...
              <div
                key={f.key}
                className={f.key === "replyTo" ? "col-span-2" : ""}
              >
                <label
                  className="block text-xs font-medium uppercase tracking-widest mb-2"
                  style={{ color: "#444" }}
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEmailSettings((s) => ({ ...s, [f.key]: e.target.value }))
                  }
      ...
      <Section
        ...
        description="Customize the email sent to contributors when their submission is rejected. Use {name} and {reason} as placeholders."
      >
          ...
          >
            ...
            {["{name}", "{reason}", "{division}", "{year}"].map((p) => (
              <span
                ...
                style={{ background: "#1a1a1a", color: "#00c8ff" }}
              >
                {p}
              </span>
            ))}
      ...
      <Section
        ...
        description="Control how submissions are handled"
      >
        <div>
          <Toggle
      ...
      <Section
        ...
        description="Divisions currently visible in the library"
      >
