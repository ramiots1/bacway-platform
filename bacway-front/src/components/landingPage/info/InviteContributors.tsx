        ...
        <div className="flex flex-col gap-3" dir={dir}>
          ...
          <div className="flex justify-end gap-6 items-center">
            ...
            <button
              onClick={handleSend}
              disabled={!canSubmit}
              className="px-6 py-2 rounded-lg bg-blue-500 hover:bg-blue-500 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-semibold transition-colors duration-200"
            >
              {status === 'loading'
